...
namespace WMS.Models
{
    ...
    public partial class WHS_GoodReceiptNote
    {
        ...
        public string TagStr { get; set; }
			...
			        [Column("Date_time_print_GRN")]        [DataMember]        [DataType(DataType.Date)]        public Nullable<DateTime> Date_time_print_GRN { get; set; }
			        [Column("ID")]        [DataMember]        [Key]        [UIHint("Integer")]        [Required(ErrorMessageResourceType = typeof(App_GlobalResources.lang_WHS), ErrorMessageResourceName = "GoodReceiptNote_ID_Required")]        public int ID { get; set; }
